...
export function PositionEvolutionChart({
  ...
  return (
    <div className="bg-surface/60 backdrop-blur border border-border rounded-2xl shadow-card p-6">
      ...
      <div
        ref={containerRef}
        className="relative mt-4 overflow-x-auto select-none [-webkit-tap-highlight-color:transparent] [-webkit-touch-callout:none] [overflow-anchor:none] touch-manipulation"
